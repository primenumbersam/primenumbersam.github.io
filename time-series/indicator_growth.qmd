...
author: "GitSAM"
date: 03/18/2025
keywords: 경제성장, 자연성장률, 실질 GDP, 중위임금
format:
  html:
    code-fold: true
    toc: true
...
## Real GDP vs. Real Median Wage

### 문제 제기: 통화 공급과 명목 GDP 증가  
...
이를 더 잘 반영하는 지표는 Real GDP per capita 보다 **Real Median Wage(실질 중위임금)** 이 될 수 있다.  
...
### 경제 성장 예측: Natural GDP Rate vs. Consumer Sentiment
