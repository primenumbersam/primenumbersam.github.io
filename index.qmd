...
<div class="feature-card" style="background-color: #DBEAFE;">
  ...
  <p class="feature-text">
    Notion-like Corpus, AI Auto-tagging
  </p>
...
## Services & Solution = 유료

- **Online Lecture:** Math Exam, Business **AppScripts**, (vs. inflearn, teachable)
- **Data Parsing & Labeling:** From Raw data to Structured **Dashboard** (vs. Palantir, SelectStar, Newen AI, AIMMO)
- **Personal Server Solution:** Decentralized Cloud vOS with SLM (vs. UmbrelOS, CasaOS)
- **Socratic SLM Solution:** AI-equipped doll (vs. 카티 인형)
:::
