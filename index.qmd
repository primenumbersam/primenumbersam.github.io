...
subtitle: for FOSS (Free, Open, Simple, Solutions)
format:
  html:
    toc: false
    echo: false
...
<div class="feature-card" style="background-color: #D1FAE5;">
  ...
  <p class="feature-subtext">
    (vs. Naver Finance, DeepSearch, Finviz)
  </p>
</div>
...
*Lego-like OSS + Vibe-Coding Playground*

- SNS Recipe (Workflow Manual, Blueprint, Playbook): Naver SmartStore, Coupang
  - Branding ‘Text’ Generator
  - Branding ‘Media’ Generator
- SNS Bot (Workflow App, FlowBot, Script): Naver Blog, Tistory, Youtube, Instagram
  - Auto Post Text Generator (GET+LLM)
  - Auto Post Uploader (POST) : Comment, re-Comment, Likes
- Market & Personal Asset Dashboard: Daily insights from companiesmarketcap, Naver Finance
