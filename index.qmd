...
<div class="feature-card" style="background-color: #F3F4F6;">
  ...
  <p class="feature-title">
    <a href="https://github.com/primenumbersam/">AI Filtering & Scoring Press</a>
  </p>
...
<div class="feature-card" style="background-color: #DBEAFE;">
  ...
  <p class="feature-title">
    <a href="https://github.com/primenumbersam/">AI Low Coding E-Commerce</a>
  </p>
  <p class="feature-text">
    Competitor Analyzer with Marketplace + Text Generator for Blog + Media Generator for Mockup + Customer Support Bot for SNS
  </p>
  <p class="feature-subtext">
...
<div class="book-card" data-tags="notion">
  <a href="https://gitsam.notion.site/" target="_blank">
    <img src="/assets/cover-han.png" alt="gitsam" />
    <div class="book-title">현타 독후감</div>
  </a>
</div>
...
<div class="book-card" data-tags="notion">
  <a href="#" target="_blank">
    ...
    <div class="book-title">각자도생 실무</div>
  </a>
</div>
...
- Rule-based → **Deep-learning based model**

:::

::: {.callout-note collapse="false"}

## Lego-like AI Wrapping Practice
