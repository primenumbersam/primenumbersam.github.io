...
<div class="text-center">
  ...
  <h3>Globally Interpretable &nbsp; <span class="text blue"></span></h3>
</div>
...
<div class="feature-card" style="background-color: #FCE7F3;">
  ...
  <p class="feature-title">
    <a href="#">Blockchain Token</a>
  </p>
  <p class="feature-text">
    보호종료아동에게 투명하고 확실하게 전달되는 기부금 장부
  </p>
...
<div class="feature-card" style="background-color: #EDE9FE;">
  ...
  <p class="feature-title">
    <a href="#">Community GPU Cloud</a>
  </p>
  <p class="feature-text">
    Kubernetes를 이용한 GPU 연산 임대
  </p>
  <p class="feature-subtext">
    (vs. runpod.io)
  </p>
...
<div class="feature-card" style="background-color: #FEF9C3;">
  ...
  <p class="feature-title">
    <a href="#">Socratic Small LM</a>
  </p>
  <p class="feature-text">
    On-device 소크라틱 LM with TTS
  </p>
  <p class="feature-subtext">
    (vs. cati 인형)
  </p>
...
<div class="book-card" data-tags="notion">
  <a href="https://gitsam.notion.site/AI-Dev-Log-1fbd716ee0de801a8a22e31dc6b9c719" target="_blank">
    <img src="/assets/cover-app-log.png" alt="gitsam" />
    <div class="book-title">gitsam 앱 개발일지</div>
  </a>
</div>
...
<div class="book-card" data-tags="notion">
  <a href="https://gitsam.notion.site/179d716ee0de8051bbadeac43a1600f1?v=58f18a25682848129e3293e8262bb370" target="_blank">
    <img src="/assets/cover-theory.png" alt="gitsam" />
    <div class="book-title">gitsam 경제적 자유</div>
  </a>
</div>
...
<div class="book-card" data-tags="notion">
  <a href="https://gitsam.notion.site/20ad716ee0de80fdacd7fe3516c4b608?v=20ad716ee0de801ea051000ce11ecfac" target="_blank">
    ...
    <div class="book-title">gitsam 표현의 자유</div>
  </a>
</div>
