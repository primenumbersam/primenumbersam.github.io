...
- **Data Parsing & Labeling:** AppScript and Dashboard (vs. SelectStar, Newen AI, AIMMO)
- **Mini Education:** Math Lectures, Macroeconomic SWOT (via inflearn, youtube) 
- **Mini Server Solution:** Decentralized Cloud vOS with LLM (vs. UmbrelOS, CasaOS)
- **Mini Socratic AI Solution:** AI-powered interactive doll (vs. Cati)
