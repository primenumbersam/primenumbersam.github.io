...
<div class="feature-card" style="background-color: #F3F4F6;">
  ...
  <p class="feature-text">
    A BERT + Transformer–powered news dashboard that deduplicates, scores for bias, and structures media feeds with community IP-hash comments — an open blog for reflective news consumption.
  </p>
...
<div class="feature-card" style="background-color: #D1FAE5;">
  ...
  <p class="feature-text">
    A backtesting playground combining macro-level TBTF strategy and micro-level daily patterns — simulate, compare, and explain portfolio strategies using LLM+SHAP hybrid logic.
  </p>
  <p class="feature-subtext">
...
<div class="feature-card" style="background-color: #FCE7F3;">
  ...
  <p class="feature-text">
    A locally hosted NSFW-ready character chatbot with self-installing Docker stack on mini-PC — built for full immersion, privacy, and anime interaction in a self-contained system.
  </p>
  <p class="feature-subtext">
...
- Rule-based model → **Deep-learning based model** (e.g. AI, LLM, Transformer, Diffusion)
...
- SNS Branding Recipe (Manual): Naver Shop, Coupang
  - Branding ‘Text’ Generator
  - Branding ‘Media’ Generator
- SNS Branding Bot (Script): Naver Blog, Tistory, Instagram
  - Auto Post Generator (GET+LLM): Text, Media, metadata
  - Auto Post Uploader (POST+Playwright): Comment, re-Comment, Likes
