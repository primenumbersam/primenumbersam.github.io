...
<div class="feature-card" style="background-color: #DBEAFE;">
  ...
  <p class="feature-title">
    <a href="https://github.com/primenumbersam/">Collaborative AI System</a>
  </p>
  <p class="feature-text">
    Re-fined Re-Search Re-source
  </p>
...
## Manual Services (Paid)

- **Education Courses:** Math Lectures, Market SWOT (via inflearn, youtube) 
- **Customized Notion:** Corpus with AI tagging & refinement (vs. Notion with AI Autofill)
- **Personal Mini-Server:** Decentralized Cloud vOS with LLM (vs. UmbrelOS, CasaOS)
- **Personal Interactive Doll:** Korean-speaking & Socratic qLLM (vs. 카티 인형)
