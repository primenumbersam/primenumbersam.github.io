...
subtitle: A Reassessment of Linear Models
author: gitSAM
date: '2025-03-23'
...
Linear Models for Asset Management
...
- **Data and Descriptive Statistics**  
  ...
  - **Appendix**: Timeline of key events (e.g., QE phases, ETF milestones). 
  - **Industry Market-Cap Concentration Trends**: Time-series analysis using SIC (10) and FF (10, 49) classifications.  
...
- Are stock return distributions increasingly asymmetric and heterogeneous?  
- How market distortions (e.g. wealth concentration and polarization) affect allocative efficiency?  
- What drives the TBTF strategy’s success and its implications? 
