...
The system does not select for good outcomes—it selects **what fits**.

> Equilibrium is not the name for balance, but the **limit of motion under constraint**.  
> It is where the system stops—not because it should—but because it **can go no further**.
