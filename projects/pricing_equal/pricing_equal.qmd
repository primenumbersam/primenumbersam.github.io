...
print(f"\nProletariat Class Call Option Price: {option_price_proletariat:.2f}")
print(f"Capitalist Class Call Option Price: {option_price_capitalist:.2f}")
```
